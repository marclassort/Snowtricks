 ...
 */
final class Version20211225173333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD first_image_id INT DEFAULT NULL, DROP firstImage');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD firstImage INT NOT NULL, DROP first_image_id');
