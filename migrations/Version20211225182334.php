 ...
 */
final class Version20211225182334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick CHANGE first_image_id first_image_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick CHANGE first_image_id first_image_id INT DEFAULT NULL');
